<footer class="bg-gradient-to-b from-red-900 to-black text-white mt-16 shadow-2xl relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-10 border-b border-gray-700">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Beranda</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Produk</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Promo</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Transaksi</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Profil Agen</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Cara Berbelanja</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Ketentuan Pengiriman</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Kebijakan Privasi</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-red-300 transition duration-200">Hubungi Kami</a></li>
                </ul>
            </div>
            ...
            <div class="col-span-2 md:col-span-1 space-y-3">
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    <li class="flex items-start space-x-2">
                        <svg class="w-5 h-5 flex-shrink-0 mt-1 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        <span>Jl. Raya Tembarak, Wonokerso Kulon, Wonokerso, Kec. Tembarak, Kabupaten Temanggung, Jawa Tengah 56261 </span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <svg class="w-5 h-5 flex-shrink-0 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <a href="mailto:info@fanjay.co.id" class="hover:text-red-300">BerkahJayaLumintu@gmail.com</a>
                    </li>
                    <li class="flex items-center space-x-2">
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-4">
