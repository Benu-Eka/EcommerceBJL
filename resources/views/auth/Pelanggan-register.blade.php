    ...
    <div class="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full bg-white p-8 rounded-xl shadow-lg">
            ...
            <form method="POST" action="{{ route('pelanggan.register') }}" class="space-y-4">
                ...
                {{-- NPWP --}}
                <div>
                    <label for="NPWP" class="block text-sm font-medium text-gray-700 mb-1">Nomor NPWP</label>
                    <input id="NPWP" name="NPWP" type="text" value="{{ old('NPWP') }}"
                           class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="Opsional">
                </div>
